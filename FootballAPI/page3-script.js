...
function insertTable(data) {
  ...
  let output = '<div class="flex gap-7">';
  ...
  data.forEach((team, index) => {
    ...
    output += " <div class='ml-auto'>" + team.won + "</div>";
    output += " <div class='ml-auto'>" + team.draw + "</div>";
    output += " <div class='ml-auto'>" + team.lost + "</div>";
    output += " <div class='ml-auto'>" + team.goals + "</div>";
    output += " <div class='ml-auto'>" + team.opponentGoals + "</div>";
    output += " <div class='ml-auto'>" + team.goalDiff + "</div>";
    output += " <div class='font-bold ml-auto'>" + team.points + "</div>";
    output += "</div>";

    if ((index + 1) % 2 == 0) {
      output += '</div><div class="flex gap-7">';
    }
  });
